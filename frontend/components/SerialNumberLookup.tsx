...
export default function SerialNumberLookup() {
  ...
  return (
    <div style={{
      ...
      <p id="serial-lookup-desc" style={{ fontSize: "0.875rem", color: colors.neutral[500], margin: "0 0 1rem" }}>
        Enter any credit serial number to see its complete history — from issuance to retirement.
      </p>

      <form onSubmit={handleSearch} style={{ display: "flex", gap: "0.75rem", marginBottom: "1.5rem" }}>
        <label htmlFor="serial-input" style={{ position: "absolute", width: 1, height: 1, overflow: "hidden", clip: "rect(0,0,0,0)", whiteSpace: "nowrap" }}>
          Credit serial number
        </label>
        <input
          id="serial-input"
          type="text"
          aria-label="Credit serial number"
          aria-describedby="serial-lookup-desc"
      ...
      <div aria-live="polite" aria-atomic="true">
        ...
        {error && <p role="alert" style={{ color: "#dc2626", fontSize: "0.875rem" }}>Serial number not found.</p>}
